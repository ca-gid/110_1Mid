...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:CheckBoxList ID="CheckBoxList1" runat="server" AutoPostBack="True" RepeatDirection="Horizontal" RepeatLayout="Flow">
            ...
            <asp:HyperLink ID="HyperLink1" runat="server" ImageUrl="~/youtube-brands.svg" NavigateUrl="https://www.youtube.com" Height="30px" Width="30px"></asp:HyperLink><br />
